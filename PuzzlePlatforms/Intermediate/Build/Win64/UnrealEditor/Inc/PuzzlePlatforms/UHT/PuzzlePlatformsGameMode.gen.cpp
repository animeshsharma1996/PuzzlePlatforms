...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_APuzzlePlatformsGameMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_APuzzlePlatformsGameMode_Statics::ClassParams = {
		...
		0,
		0x008802ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APuzzlePlatformsGameMode_Statics::Class_MetaDataParams), Z_Construct_UClass_APuzzlePlatformsGameMode_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_UETutMP_PuzzlePlatforms_Source_PuzzlePlatforms_PuzzlePlatformsGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UETutMP_PuzzlePlatforms_Source_PuzzlePlatforms_PuzzlePlatformsGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APuzzlePlatformsGameMode, APuzzlePlatformsGameMode::StaticClass, TEXT("APuzzlePlatformsGameMode"), &Z_Registration_Info_UClass_APuzzlePlatformsGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APuzzlePlatformsGameMode), 3313074704U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UETutMP_PuzzlePlatforms_Source_PuzzlePlatforms_PuzzlePlatformsGameMode_h_1784741837(TEXT("/Script/PuzzlePlatforms"),
		Z_CompiledInDeferFile_FID_UETutMP_PuzzlePlatforms_Source_PuzzlePlatforms_PuzzlePlatformsGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UETutMP_PuzzlePlatforms_Source_PuzzlePlatforms_PuzzlePlatformsGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
